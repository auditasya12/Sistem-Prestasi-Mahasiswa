...
<script>
    $(document).ready(function() {
        $('#roles').change(function() {
            ...
            if (kel == "mahasiswa") {
                $("#noId").html('<label for="nim">NIM Mahasiswa</label><input id="nim" type="text" onkeypress="return inputAngka(event)" placeholder="NIM" class="form-control" name="nim" autocomplete="off">');
            } else if (kel == "admin") {
