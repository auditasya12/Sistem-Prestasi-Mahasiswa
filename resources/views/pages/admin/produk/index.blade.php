...
@section('title', 'List Hasil Desain Produk')
...
<section class="section custom-section">
    <div class="section-body">
        ...
        <!-- <small style="color:#fff">
            (Capaian unggulan produk merupakan wujud capaian meraih gelar kejuaraan. Dapat berupa lomba bidang penalaran, olahraga, kesenian, keagamaan, atau sejenisnya). 
        </small> -->
        </div>
        <div class="row">
            <div class="col-12">
                            ...
                            <table class="table table-striped" id="table-2">
                                ...
                                @foreach ($produk as $result => $data)
                                    ...
                                    ?>
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('produk.show', Crypt::encrypt($data->id)) }}" class="btn btn-primary btn-sm" style="margin-right: 8px"><i class="nav-icon fas fa-info"></i> &nbsp; Verifikasi</a>
                                                <a href="{{ route('produk.edit', Crypt::encrypt($data->id)) }}" class="btn btn-success btn-sm"><i class="nav-icon fas fa-edit"></i> &nbsp; Edit</a>
